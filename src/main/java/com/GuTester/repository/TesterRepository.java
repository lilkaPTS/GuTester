...
public interface TesterRepository extends JpaRepository<Tester, Long> {
    ...
    @Query(value = "SELECT * FROM tester \n" +
            ...
            "/* отбор тестировщиков с нужным оператором СС             */AND (   false = :checkMobileOperator or tester.mobile_operator_id in (select omo.mobile_operator_id from orders_mobile_operator omo where omo.orders_id = :orderId));", nativeQuery = true)
